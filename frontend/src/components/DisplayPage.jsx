...
const DisplayPage = ({ resumeData }) => {
  ...
  const [formData, setFormData] = useState(() => ({
    ...
    Skills: {
      ProgrammingLanguages: Array.isArray(resumeData?.ProgrammingLanguages)
        ? resumeData.ProgrammingLanguages
        : resumeData?.ProgrammingLanguages
        ? [resumeData.ProgrammingLanguages]
        : [],
      WebTechnologies: Array.isArray(resumeData?.WebTechnologies)
        ? resumeData.WebTechnologies
        : resumeData?.WebTechnologies
        ? [resumeData.WebTechnologies]
        : [],
      OtherSkills: Array.isArray(resumeData?.OtherSkills)
        ? resumeData.OtherSkills
        : resumeData?.OtherSkills
        ? [resumeData.OtherSkills]
        : [],
      ToolsandFrameworks: Array.isArray(resumeData?.ToolsandFrameworks)
        ? resumeData.ToolsandFrameworks
        : resumeData?.ToolsandFrameworks
        ? [resumeData.ToolsandFrameworks]
        : [],
      Databases: Array.isArray(resumeData?.Databases)
    ...
    Achievements: resumeData?.Achievements
      ? Object.values(resumeData.Achievements)
      : [],
  ...
  const sections = [
    {
      ...
      content: (
        <div className={styles.formSection}>
          ...
          {["Name", "Email", "PhoneNumber", "GitHub", "LinkedIn", "Role"].map(
            (field) => (
              <p className={styles.displayPageParagraph} key={field}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange(e, field, "PersonalDetails")
                  }
    ...
    },
    {
      ...
      content: (
        <section className={styles.formSection}>
          <h2 className={styles.displayPageSubHeader}>
              ...
              {["Institution", "Year", "Degree", "Results"].map((field) => (
                <p className={styles.displayPageParagraph} key={field}>
                  ...
                  <input
                    ...
                    value={edu[field]}
                    onChange={(e) =>
                      handleInputChange(e, field, "Education", index)
                    }
            ...
            <div key={index} className={styles.dynamicSection}>
              <p className={styles.displayPageParagraph}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange(e, "ProjectName", "Projects", index)
                  }
